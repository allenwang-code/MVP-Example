...
import static com.appdeveloper.allenwang.mvp.ui.main.TestUtils.waitId;
...
public class MainActivityTest {
    ...
    public void mainActivityTest() {
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.main_searchView),
                        childAtPosition(
                                childAtPosition(
        ...
        onView(isRoot()).perform(waitId(R.id.textView_name, TimeUnit.SECONDS.toMillis(5)));

        recyclerView.perform(actionOnItemAtPosition(1, click()));
    }

    @Test
    public void mainActivityTestWithNoResult() throws InterruptedException {
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.main_searchView),
                        childAtPosition(
                                childAtPosition(
    ...
    @Test
    public void mainActivityTestWithShortInput() {
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.main_searchView),
                        childAtPosition(
                                childAtPosition(
